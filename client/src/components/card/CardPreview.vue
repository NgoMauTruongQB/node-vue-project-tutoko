<template>
    <div class="card-preview p-2">
        <div class="card py-4 px-3">
            <div class="row">
                <div class="col-md-5 cell d-flex align-items-center">
                    あけましておめでとうございます
                </div>
                ...
                <div class="col-md-2 d-flex align-items-center justify-content-center">
                    ...
                    <button class="btn-update mx-1 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
                    ...
                    <button class="btn-delete mx-1 d-flex align-items-center justify-content-center">
